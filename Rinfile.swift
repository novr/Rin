let policy = Rin.Policy {
    ...
    Rules {
        Rule(id: "cli_returns_exitcode") {
            MustCall(receiver: .symbol("ExitCode"), method: "rawValue")
        }
        ...
        Rule(id: "engine_wraps_violation_error") {
            MustCall(receiver: .symbol("RinterEngineError"), method: "violation")
        }
        ...
        Rule(id: "engine_wraps_runtime_error") {
            MustCall(receiver: .symbol("RinterEngineError"), method: "runtime")
        }
        .scope(include: ["Sources/RinCore/RinterEngine.swift"])
        ...
        Rule(id: "plugin_waits_for_process") {
            WhenCalls(receiver: .symbol("process"), method: "run")
                .mustAlsoCall(receiver: .symbol("process"), method: "waitUntilExit")
        }
